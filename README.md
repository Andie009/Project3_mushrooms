# Project3_mushrooms
My inspiration for this project was two fold: 1, a trip to Italy a few years ago where I saw locals foraging for mushrooms in the forest in Abruzzo and also finding strange mushrooms in my backyard or when out hiking. I have always asked myself, "I wonder if this mushroom is edible?"  
I used a mushroom csv dataset I found on kaggle to try create an app where the user could enter physical characteristics of their mushroom and the app would return an answer of edible (e) or poisonous (p).  
